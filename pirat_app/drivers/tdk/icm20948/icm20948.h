...
#define ICM20948_REG_FIFO_COUNT_H 0x70
#define ICM20948_REG_FIFO_COUNT_L 0x71
...
struct icm20948_config {
  ...
  uint8_t accel_fs;
  uint8_t accel_hz; // NY: Accel sample rate index
  uint8_t accel_fchoice;
  uint8_t accel_lpf;
  uint8_t gyro_fs;
  uint8_t gyro_hz; // NY: Gyro sample rate index
  uint8_t gyro_fchoice;
  uint8_t gyro_lpf;
  uint8_t mag_freq;
  uint16_t gyro_sample_rate_div;  // NY: Added for custom gyro rate
  uint16_t accel_sample_rate_div; // NY: Added for custom accel rate
};
